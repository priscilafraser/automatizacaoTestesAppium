...
class AndroidBudget(unittest.TestCase):
    def setUp(self):
        ...
        desired_caps['deviceName'] = 'RX8T602267D'
    ...
    def test_app_NomeValorVazio(self):
        ...
        self.assertEqual(TestData.nomeValorVazio, elementVazio2,
                         "O campo nome e valor estão vazios. Não pode salvar. Preencha corretamente")
    ...
    def test_app_formatoDeData(self):
        ...
        try:
            ...
            self.assertTrue(data_selecionada <= data_atual,
                            "A data selecionada é uma data futura. Não deve permitir data futura!!")
        except ValueError:
    ...
    def test_app_valorVazio(self):
        ...
        try:
            elementVazio = self.driver.find_element(By.XPATH,
                                                    "//android.widget.TextView[contains(@resource-id, 'protect.budgetwatch:id/snackbar_text')]")
            elementVazio2 = elementVazio.get_attribute('text')
            self.assertEqual(TestData.valorVazio, elementVazio2,
                             "O campo VALUE está vazio. Não pode salvar. Preencha corretamente")
        except NoSuchElementException:
            pass
    ...
    def test_app_valueComCaracter(self):
        ...
        try:
            elementVazio = self.driver.find_element(By.XPATH,
                                                    "//android.widget.TextView[contains(@resource-id, 'protect.budgetwatch:id/snackbar_text')]")
            elementVazio2 = elementVazio.get_attribute('text')
            self.assertEqual(TestData.valorInvalido, elementVazio2,
                             "O campo VALUE está vazio. Não pode salvar. Preencha corretamente")
        except NoSuchElementException:
            pass
    ...
    def test_app_valueNegativo(self):
        ...
        try:
            ...
            self.fail(
                "O campo VALUE nao pode ser numero negativo. Não pode salvar. Deveria ter snackbar_text com 'Value invalid'")
